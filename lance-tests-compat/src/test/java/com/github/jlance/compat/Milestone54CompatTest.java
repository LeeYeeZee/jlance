...
/**
 * Compatibility test for large_list&lt;struct&lt;list&lt;int&gt;&gt;&gt;.
 */
public class Milestone54CompatTest {

  private static final Path DATA_DIR = Paths.get("..", "compat_tests", "data", "milestone_54");

  @Test
  public void testLargeListStructList() throws Exception {
    Path file = DATA_DIR.resolve("test_large_list_struct_list.lance");
    try (BufferAllocator allocator = new RootAllocator();
      ...
      try (VectorSchemaRoot root = reader.readBatch(allocator)) {
        ...
        LargeListVector outerList = (LargeListVector) root.getVector("data");
